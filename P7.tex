...
\newpage
\input{./chapters/01.intro/radio.tex}
\newpage
\input{./chapters/02.state/state_of_the_art.tex}
\newpage
\input{./chapters/03.benchmark/benchmark.tex}
\newpage
\input{./chapters/04.impl/impl.tex}
\newpage
\input{./chapters/05.results/results.tex}
\newpage
\input{./chapters/06.conclusion/conclusion.tex}
