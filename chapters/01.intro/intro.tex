...
However, Radio Interferometers, where many antennas together act as a single instrument, achieve angular resolutions that are comparable to a dish with several kilometer diameters. 

In the past, interferometers like VLA, ALMA and LOFAR have made numerous discoveries.

However, Radio Interferometers achieve angular resolutions that are comparable to a single dish with a diameter of several kilometers. Instead of one antenna, Interferometers use pairs of smaller antennas spaced apart.
...
\subsection{The Compressed Sensing Reconstruction Framework}
...
\begin{itemize}
	...
	\item A prior function $p()$ in which transforms the image into a sparse domain.
