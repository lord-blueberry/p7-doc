...
The separate parts have a degree of interchangeability. The prior can be exchanged while keeping the objective and the optimization algorithm, which was frequently done during the course of this project. However each part is not fully interchangeable. If the chosen objective is non-convex, it limits the available optimization algorithms. How each part influences each other is discussed in section \ref{cs}.
